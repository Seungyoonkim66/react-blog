...
function Header() {
    ...
    const themeToggleIcon = isDark ? <LightModeOutlinedIcon /> : <DarkModeOutlinedIcon />;
    return (
        <HeaderContainer id="main-header" theme={isDark ? theme.dark : theme.light}>
            <Container className="header-container">
                ...
                <div>
                    <Button variant="outlined" className="root-btn" onClick={() => setIsDark(!isDark)}>
                        {themeToggleIcon}
                    </Button>
                    <Button variant="outlined" className="root-btn" onClick={() => console.log("menu open")}>
